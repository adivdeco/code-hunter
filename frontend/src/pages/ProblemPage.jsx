...
import { Bookmark, RotateCcw, ChevronUp, ChevronDown, Maximize2, Minimize2, Minimize, CheckSquare, Volleyball, CloudUpload, BrainCircuit, Trash2, SettingsIcon, Timer, Layers, Crown } from 'lucide-react';
                      ...
                      {user?.isPaidUser ? (
                        ...
                        <div className="w-full h-full relative">
                          ...
                          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-black/30 rounded-lg text-center p-4">
                            <LockIcon className="w-16 scale-150 h-16 text-yellow-400" />

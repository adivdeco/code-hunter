...
//       window.location.href = `${process.env.REACT_APP_API_URL || 'http://localhost:5500'}/auth/github`;
//     } catch (err) {
...
//                       autoComplete="email"
//                       className={cn(
//                         "block w-full pl-10 pr-3 py-2 rounded-lg border-none bg-white/5 text-white placeholder-white/40 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all duration-300",
...
//                       className={cn(
//                         "block w-full pl-10 pr-10 py-2 rounded-lg border-none bg-white/5 text-white placeholder-white/40 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all duration-300",
...
//                     <span className="px-2 bg-black/30 text-white/70">Or continue with</span>
//                   </div>
//                 </div>
